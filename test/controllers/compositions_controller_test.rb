...
class CompositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create composition" do
    assert_difference("Composition.count") do
      post compositions_url, params: { composition: { description: @composition.description, instruments: @composition.instruments, name: @composition.name } }
    end
  ...
  test "should update composition" do
    patch composition_url(@composition), params: { composition: { description: @composition.description, instruments: @composition.instruments, name: @composition.name } }
